        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCheckInAt = table.Column<DateTime>(type: "timestamptz", nullable: true),
                    LastCheckOutAt = table.Column<DateTime>(type: "timestamptz", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceStates_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalDxfPath = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    TileDirectory = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    ...
                    BoundsJson = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeatAssignments_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceStates_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatAssignments_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_FloorId_SeatNumber",
                table: "Seats",
                columns: new[] { "FloorId", "SeatNumber" },
                unique: true);
        }
